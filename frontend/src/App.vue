...
:root {
  --primary-color: #41a4f5;
  --primary-color-dark: #0a71c6;
  --hover-color-dark: rgba(0, 0, 0, 0.2);
  --white-color: #ffffff;
  --text-color: #434e5e;
  --text-color-secondary: #58677c;
...
::-webkit-scrollbar-thumb {
  ...
  box-shadow: inset 1px 2px 3px 1px rgba(51, 51, 51, 0.5);
}
